...
// CORS Configuration
// const corsOptions = {
//   origin: process.env.CORS_ORIGIN || 'http://bizz.oxodigital.agency',
//   credentials: true,
...
app.use('/api/issued-cheques', require('./routes/issuedCheques'));
app.use('/api/party-cheques', require('./routes/partyCheques'));
